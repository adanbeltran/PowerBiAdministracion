# Taller 21. Proyecto integrador II
...
Caso de estudio del taller: El estudiante presenta ejecutivamente su solución analítica y justifica decisiones de modelado y diseño.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Sustentación y presentación ejecutiva.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: defensa gerencial de hallazgos. Ingeniería Industrial: defensa técnica y de impacto operacional.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** interpretación de resultados.
...
- **Power BI:** storytelling, dashboards, navegación, filtros, KPIs e interpretación visual.
- **DAX:** ajuste final de medidas y documentación.
- **SQL:** trazabilidad de consultas usadas.
- **Python:** anexos de validación si se emplearon.
...
**Dataset sugerido para el trabajo en clase:** Dataset libre

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Dataset libre**.
...
6. Crear medidas y/o columnas DAX enfocadas en: revisión final de DAX, consistencia entre preguntas e indicadores, síntesis ejecutiva.
7. Diseñar visualizaciones con énfasis en: storytelling, dashboards, navegación, filtros, KPIs e interpretación visual.
...
- ¿cómo se justifica cada decisión analítica?
- ¿qué hallazgos son accionables?
- ¿qué limita el análisis realizado?

### Operaciones mínimas que deben implementarse

- revisión final de DAX
- consistencia entre preguntas e indicadores
- síntesis ejecutiva
...
**Nuevo contexto:** preparar una sustentación ejecutiva con evidencia analítica.

**Dataset del reto:** continuación del proyecto integrador.

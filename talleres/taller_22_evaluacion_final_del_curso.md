# Taller 22. Evaluación final del curso
...
Caso de estudio del taller: Se evalúa integralmente la capacidad para estructurar un análisis, construir un dashboard y defender resultados.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Examen final.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: síntesis de habilidades para escenarios empresariales. Ingeniería Industrial: síntesis para escenarios operacionales y de control.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** síntesis e interpretación.
...
- **Power BI:** dashboard final, medidas DAX, visualizaciones y sustentación.
- **DAX:** selección integral de medidas y columnas.
- **SQL:** consulta o trazabilidad de extracción.
- **Python:** uso opcional para validación.
...
6. Crear medidas y/o columnas DAX enfocadas en: integración de DAX, coherencia visual, defensa del análisis.
7. Diseñar visualizaciones con énfasis en: dashboard final, medidas DAX, visualizaciones y sustentación.
...
- ¿el tablero responde al problema?
- ¿los indicadores están bien definidos?
- ¿la interpretación es coherente con los datos?

### Operaciones mínimas que deben implementarse

- integración de DAX
- coherencia visual
- defensa del análisis
...
**Nuevo contexto:** entrega integral del caso seleccionado.

**Dataset del reto:** proyecto del estudiante.

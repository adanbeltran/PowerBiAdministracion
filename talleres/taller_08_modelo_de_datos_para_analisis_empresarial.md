# Taller 08. Modelo de datos para análisis empresarial
...
Caso de estudio del taller: Un modelo mal construido produce duplicidades y métricas erróneas.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Modelado de datos.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: modelo para análisis comercial consistente. Ingeniería Industrial: estructura de datos para cadena de suministro y operaciones.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** correlación de Pearson.
...
- **Power BI:** modelo estrella, relaciones, dimensiones, hechos, jerarquías y medidas.
- **DAX:** RELATED, RELATEDTABLE, SUMX, COUNTROWS, medidas en hechos.
- **SQL:** modelo relacional, llaves y JOINs.
- **Python:** validación de relaciones y correlaciones básicas.
...
**Dataset sugerido para el trabajo en clase:** Olist Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Olist Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: creación de medidas sobre modelo estrella, uso de relaciones, lectura de correlaciones simples.
7. Diseñar visualizaciones con énfasis en: modelo estrella, relaciones, dimensiones, hechos, jerarquías y medidas.
...
- ¿qué tabla debe ser hecho y cuáles dimensiones?
- ¿cómo evitar duplicidades en indicadores?
- ¿qué relación existe entre variables numéricas clave?

### Operaciones mínimas que deben implementarse

- creación de medidas sobre modelo estrella
- uso de relaciones
- lectura de correlaciones simples
...
**Nuevo contexto:** diseñar un modelo estrella para compras, inventario o ventas.

**Dataset del reto:** varias tablas de un proceso empresarial.

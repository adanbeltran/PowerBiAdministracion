# Taller 18. Análisis de talento humano
...
Caso de estudio del taller: La organización busca entender rotación, satisfacción y perfil del personal.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Analítica organizacional y recursos humanos.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: talento humano y clima organizacional. Ingeniería Industrial: análisis de asignación de personal, ausentismo y rotación en operaciones.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** muestreo.
...
- **Power BI:** dashboards, filtros, RLS conceptual, tarjetas, barras y matrices.
- **DAX:** rotación, conteos por segmento, IF, CALCULATE.
- **SQL:** consultas por área, cargo y estado del empleado.
- **Python:** muestreo descriptivo y análisis exploratorio de RRHH.
...
**Dataset sugerido para el trabajo en clase:** IBM HR Analytics

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **IBM HR Analytics**.
...
6. Crear medidas y/o columnas DAX enfocadas en: tasas y conteos por grupo, segmentación de empleados, comparación entre áreas.
7. Diseñar visualizaciones con énfasis en: dashboards, filtros, RLS conceptual, tarjetas, barras y matrices.
...
- ¿qué grupos presentan más rotación?
- ¿qué variables parecen asociarse con la salida del empleado?
- ¿qué recomendaciones surgen para gestión humana?

### Operaciones mínimas que deben implementarse

- tasas y conteos por grupo
...
**Nuevo contexto:** analizar factores asociados a permanencia o rotación.

**Dataset del reto:** base de RRHH o personal.

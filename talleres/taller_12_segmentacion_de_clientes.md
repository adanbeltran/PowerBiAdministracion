# Taller 12. Segmentación de clientes
...
Caso de estudio del taller: No todos los clientes generan el mismo valor y se requiere segmentarlos.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Analítica de clientes y valor del cliente.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: clientes de alto valor y retención. Ingeniería Industrial: clasificación de clientes o pedidos por criticidad.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** clustering conceptual y segmentación.
...
- **Power BI:** scatter plot, segmentación, tablas resumen, filtros y medidas DAX.
- **DAX:** segmentos con IF/SWITCH, percentiles simples, CALCULATE.
- **SQL:** agregación por cliente y segmentos.
- **Python:** segmentación exploratoria con pandas y nociones de clustering.
...
6. Crear medidas y/o columnas DAX enfocadas en: columnas de segmentación, medidas por segmento, gráficos de dispersión para identificar grupos.
7. Diseñar visualizaciones con énfasis en: scatter plot, segmentación, tablas resumen, filtros y medidas DAX.
...
- ¿qué grupos de clientes gastan más?
- ¿cómo separar clientes frecuentes de ocasionales?
- ¿qué acciones gerenciales surgirían de la segmentación?

### Operaciones mínimas que deben implementarse

- columnas de segmentación
- medidas por segmento
- gráficos de dispersión para identificar grupos
...
**Nuevo contexto:** segmentar clientes para priorizar campañas o servicio.

**Dataset del reto:** DirectMarketing.csv o retail.

# Taller 14. Análisis de escenarios financieros
...
Caso de estudio del taller: La dirección financiera quiere comparar distintos escenarios posibles.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Segundo parcial y simulación financiera.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: evaluación de ingresos, costos y utilidad bajo supuestos. Ingeniería Industrial: análisis de escenarios de costo, capacidad o productividad.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** regresión múltiple.
...
- **Power BI:** what-if parameters, simulación, waterfall, tablas comparativas y medidas dinámicas.
- **DAX:** parámetros what-if, SELECTEDVALUE, medidas dinámicas, IF.
- **SQL:** escenarios con supuestos y comparación de resultados.
- **Python:** simulación sencilla de escenarios y sensibilidad.
...
**Dataset sugerido para el trabajo en clase:** Financial Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Financial Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: medidas dinámicas con parámetros, comparación de escenarios, sensibilidad simple.
7. Diseñar visualizaciones con énfasis en: what-if parameters, simulación, waterfall, tablas comparativas y medidas dinámicas.
...
- ¿qué pasa si cambian ventas, costos o tasa de crecimiento?
- ¿qué variable impacta más el resultado?
- ¿qué escenario es más favorable o riesgoso?

### Operaciones mínimas que deben implementarse

- medidas dinámicas con parámetros
...
**Nuevo contexto:** simular supuestos para apoyar una decisión gerencial.

**Dataset del reto:** archivo financiero con variables de escenario.

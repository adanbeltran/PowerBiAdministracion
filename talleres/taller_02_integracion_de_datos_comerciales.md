# Taller 02. Integración de datos comerciales
...
Caso de estudio del taller: La información de clientes, productos y ventas está en varios archivos y debe integrarse.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** ETL aplicado a negocios.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: consolidación de clientes, ventas y pagos. Ingeniería Industrial: integración de datos de producción, inventario y despacho.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** técnicas de muestreo.
...
- **Power BI:** Merge, Append, transformación de datos, vista modelo, tablas y matrices.
- **DAX:** RELATED, RELATEDTABLE, SUMX, COUNTROWS.
- **SQL:** JOIN, UNION ALL y claves primarias/foráneas.
- **Python:** merge de tablas con pandas y validación de llaves.
...
**Dataset sugerido para el trabajo en clase:** Olist E-commerce Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Olist E-commerce Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: unión de tablas, validación de cardinalidad, medidas agregadas después de integrar.
7. Diseñar visualizaciones con énfasis en: Merge, Append, transformación de datos, vista modelo, tablas y matrices.
...
- ¿cómo integrar distintas tablas sin perder consistencia?
- ¿qué llaves permiten unir correctamente la información?
- ¿qué errores aparecen al combinar fuentes?

### Operaciones mínimas que deben implementarse

- unión de tablas
- validación de cardinalidad
- medidas agregadas después de integrar
...
**Nuevo contexto:** integrar pedidos, inventario y pagos para construir una vista única del negocio.

**Dataset del reto:** dos o más archivos de operación comercial.

...
Caso de estudio del taller: Espacio de cierre académico para revisar aprendizajes, errores comunes y oportunidades de mejora.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Retroalimentación y mejora continua.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: transferencia del aprendizaje a contextos reales. Ingeniería Industrial: mejora continua de soluciones analíticas.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** reflexión analítica.
...
- **Power BI:** revisión integral del dashboard y conclusiones.
- **DAX:** buenas prácticas y refactorización.
- **SQL:** buenas prácticas de consulta y trazabilidad.
- **Python:** buenas prácticas de validación y reproducibilidad.
...
**Dataset sugerido para el trabajo en clase:** Proyecto del estudiante

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Proyecto del estudiante**.
...
6. Crear medidas y/o columnas DAX enfocadas en: documentación final, mejora de medidas, reflexión metodológica.
7. Diseñar visualizaciones con énfasis en: revisión integral del dashboard y conclusiones.
...
- ¿qué aprendió el estudiante sobre datos y decisiones?
- ¿qué errores debe evitar en futuros proyectos?
- ¿cómo mejorar la reproducibilidad del análisis?
...
**Nuevo contexto:** plantear una versión mejorada del proyecto para una segunda iteración.

**Dataset del reto:** mismo proyecto final.

# Taller 19. Publicación y colaboración en BI
...
Caso de estudio del taller: No basta con analizar; también hay que publicar, compartir y gobernar la información.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Power BI Service y cultura de datos.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: circulación de información para la toma de decisiones. Ingeniería Industrial: difusión controlada de KPIs en áreas operativas.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** pruebas de hipótesis.
...
- **Power BI:** publicación, dashboards online, Power BI Service, alertas y paneles.
- **DAX:** revisión y documentación de medidas existentes.
- **SQL:** consulta fuente y trazabilidad de datos.
- **Python:** automatización simple de exportes o revisión documental.
...
**Dataset sugerido para el trabajo en clase:** Retail Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Retail Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: ajuste final de medidas, documentación de indicadores, validación previa a publicación.
7. Diseñar visualizaciones con énfasis en: publicación, dashboards online, Power BI Service, alertas y paneles.
...
- ¿qué visuales deben publicarse?
- ¿qué permisos o audiencias deben definirse?
- ¿cómo documentar las medidas y fuentes usadas?
...
**Nuevo contexto:** publicar un tablero con criterios de gobierno y comunicación.

**Dataset del reto:** dashboard realizado previamente.

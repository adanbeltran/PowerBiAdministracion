# Taller 16. Tablero de control de gestión
...
Caso de estudio del taller: La organización necesita monitorear KPIs de forma continua para reaccionar a tiempo.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Control empresarial y seguimiento.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: control de gestión. Ingeniería Industrial: control operacional y mejora continua.
...
- **Power BI:** semáforos, gauges, matrices con formato condicional, tarjetas y líneas de tendencia.
- **DAX:** metas, desviaciones, alertas con IF/SWITCH, RANKX.
- **SQL:** indicadores de control y desviaciones frente a meta.
- **Python:** detección simple de alertas y valores atípicos.
...
**Dataset sugerido para el trabajo en clase:** Sales / Finance Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Sales / Finance Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: desviación contra meta, semáforos, ranking de alertas.
7. Diseñar visualizaciones con énfasis en: semáforos, gauges, matrices con formato condicional, tarjetas y líneas de tendencia.
...
- ¿qué indicadores requieren alerta?
- ¿qué áreas están fuera de control?
- ¿dónde aparecen valores atípicos o desviaciones?
...
**Nuevo contexto:** construir un tablero de seguimiento de gestión u operación.

**Dataset del reto:** dataset de control con metas.

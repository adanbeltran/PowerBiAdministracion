# Taller 06. Reporte ejecutivo de ventas
...
Caso de estudio del taller: La dirección necesita un tablero ejecutivo inicial con KPIs claros.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Primer parcial y visualización inicial.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: tablero para comité comercial. Ingeniería Industrial: tablero inicial para seguimiento de producción y cumplimiento.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** medidas de tendencia central.
...
- **Power BI:** KPIs, gráficos de barras, tarjetas, slicers, filtros e interacciones.
- **DAX:** SUM, AVERAGE, DISTINCTCOUNT, CALCULATE, % participación.
- **SQL:** consultas agregadas para KPIs de ventas.
- **Python:** validación rápida de indicadores con pandas.
...
6. Crear medidas y/o columnas DAX enfocadas en: KPIs y porcentajes, comparación por segmentos, ranking simple.
7. Diseñar visualizaciones con énfasis en: KPIs, gráficos de barras, tarjetas, slicers, filtros e interacciones.
...
- ¿cuáles KPIs resumen mejor el desempeño?
- ¿qué segmentos requieren atención inmediata?
- ¿qué hallazgos deben comunicarse a gerencia?
...
**Nuevo contexto:** construir un reporte ejecutivo de una unidad de negocio.

**Dataset del reto:** dataset de ventas institucional.

# Taller 20. Proyecto integrador de analítica empresarial I
...
Caso de estudio del taller: El estudiante empieza a resolver un problema de negocio integrando preparación, modelado, DAX, análisis y visualización.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Integración de competencias y diseño analítico.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: caso libre con valor gerencial. Ingeniería Industrial: caso libre con impacto en productividad, calidad, logística o costos.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** integración estadística.
...
- **Power BI:** todos los elementos trabajados en el curso.
- **DAX:** selección libre y justificada de medidas y columnas.
- **SQL:** consulta base para extracción o consolidación.
- **Python:** apoyo para exploración, limpieza o validación.
...
6. Crear medidas y/o columnas DAX enfocadas en: selección autónoma de medidas, modelo y visuales consistentes, integración de técnicas.
7. Diseñar visualizaciones con énfasis en: todos los elementos trabajados en el curso.
...
- ¿qué preguntas analíticas lo guían?
- ¿qué modelo y qué indicadores son necesarios?

### Operaciones mínimas que deben implementarse

- selección autónoma de medidas
- modelo y visuales consistentes
...
**Nuevo contexto:** proponer y desarrollar un caso propio aplicado.

**Dataset del reto:** dataset escogido por el estudiante.

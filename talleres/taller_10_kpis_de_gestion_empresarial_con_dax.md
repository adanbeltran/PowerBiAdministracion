# Taller 10. KPIs de gestión empresarial con DAX
...
Caso de estudio del taller: Los directivos necesitan KPIs robustos para monitorear metas y resultados.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Indicadores de desempeño y control.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: control de desempeño comercial. Ingeniería Industrial: control de eficiencia, cumplimiento y productividad.
...
- **Power BI:** KPIs, tarjetas, semáforos, DAX, formato condicional y gauges.
- **DAX:** CALCULATE, DIVIDE, % variación, metas, semáforos con IF/SWITCH.
- **SQL:** consultas de indicadores y cumplimiento de metas.
- **Python:** validación y visualización básica de KPIs con pandas.
...
**Dataset sugerido para el trabajo en clase:** Retail Sales Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Retail Sales Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: medidas KPI, porcentajes de cumplimiento, semáforos y categorías de desempeño.
7. Diseñar visualizaciones con énfasis en: KPIs, tarjetas, semáforos, DAX, formato condicional y gauges.
...
- ¿qué KPI resume ventas, margen y cumplimiento?
- ¿cómo comparar contra una meta?
- ¿qué segmentos están fuera del objetivo?

### Operaciones mínimas que deben implementarse

- medidas KPI
- porcentajes de cumplimiento
- semáforos y categorías de desempeño
...
**Nuevo contexto:** construir indicadores para control gerencial u operacional.

**Dataset del reto:** dataset de seguimiento de metas.

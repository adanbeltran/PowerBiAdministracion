# Taller 04. Limpieza de datos de clientes (CRM)
...
Caso de estudio del taller: La base CRM tiene duplicados, categorías inconsistentes y vacíos que afectan la segmentación.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** Calidad y estandarización de datos de clientes.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: segmentación y fidelización. Ingeniería Industrial: depuración de maestros de clientes o proveedores.

### 2.2 Conceptos estadísticos que se aplican

**Concepto principal:** análisis de outliers.
...
- **Power BI:** Power Query, limpieza, deduplicación, recodificación, tablas y segmentadores.
- **DAX:** TRIM, UPPER, IF, COUNTROWS, CALCULATE.
- **SQL:** TRIM, UPPER, CASE WHEN, detección de duplicados.
- **Python:** limpieza de texto, duplicados y cajas de bigotes con pandas/matplotlib.
...
**Dataset sugerido para el trabajo en clase:** Bank Marketing Dataset

1. Abrir Power BI Desktop y registrar el problema de negocio que se va a resolver.
2. Cargar el dataset sugerido: **Bank Marketing Dataset**.
...
6. Crear medidas y/o columnas DAX enfocadas en: columnas de normalización de texto, conteo de duplicados, clasificación de outliers o registros a revisar.
7. Diseñar visualizaciones con énfasis en: Power Query, limpieza, deduplicación, recodificación, tablas y segmentadores.
...
- ¿qué errores de estandarización existen?
- ¿hay clientes repetidos?
- ¿qué valores extremos deben revisarse?

### Operaciones mínimas que deben implementarse

- columnas de normalización de texto
- conteo de duplicados
- clasificación de outliers o registros a revisar
...
**Nuevo contexto:** mejorar la calidad de una base para campañas o servicio.

**Dataset del reto:** base CRM o archivo de clientes.

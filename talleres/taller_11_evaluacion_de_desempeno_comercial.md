# Taller 11. Evaluación de desempeño comercial
...
Caso de estudio del taller: Se requiere comparar desempeño entre regiones, canales o periodos.

## 2. Marco teórico / conceptual

### 2.1 Concepto central del taller

**Tema del taller:** DAX aplicado al análisis gerencial.

Este taller se orienta a que el estudiante entienda cómo los datos se convierten en información útil para decidir. El foco está en interpretar el problema, comprender las variables, construir indicadores y comunicar hallazgos. Administración: benchmarking entre unidades comerciales. Ingeniería Industrial: comparación de desempeño entre líneas, centros o procesos.
...
- **Power BI:** CALCULATE, FILTER, ALL, matrices, barras apiladas y treemap.
- **DAX:** CALCULATE, FILTER, ALL, RANKX, medidas comparativas.
- **SQL:** consultas comparativas por grupo y periodo.
- **Python:** comparaciones de medias y pruebas simples.
...
6. Crear medidas y/o columnas DAX enfocadas en: medidas comparativas, ranking, análisis contra total sin filtros.
7. Diseñar visualizaciones con énfasis en: CALCULATE, FILTER, ALL, matrices, barras apiladas y treemap.
...
- ¿qué regiones superan el promedio general?
- ¿qué segmentos están rezagados?
- ¿qué evidencia apoya una diferencia relevante entre grupos?

### Operaciones mínimas que deben implementarse

- medidas comparativas
- ranking
- análisis contra total sin filtros
...
**Nuevo contexto:** comparar unidades de negocio o centros operativos.

**Dataset del reto:** dataset comercial con regiones o canales.
